# Programm aus dem Buch Programmieren super easy
# vom Verlag DK (Dorling Kindersley)
# Python 3
...
WIDTH = 800
window = Tk()
window.title('Videospiel')
c = Canvas(window, width=WIDTH, height=HEIGHT, bg='darkblue')
c.pack()

# U-Boot zeichnen
schiff_id = c.create_polygon(5, 5, 5, 25, 30,15, fill='red') # Dreieck
schiff_id2 = c.create_oval(0, 0, 30, 30, outline='red') # Kreis
SCHIFF_R = 15 # Radius
MID_X = WIDTH / 2
MID_Y = HEIGHT / 2
...
#leere Listen für die Eigenschaften der Blasen
bub_id = list()
bub_r = list()
bub_geschw = list()

# minimale und maximale Anzahl der Blasen
MIN_BUB_R = 10
MAX_BUB_R = 30
...
# Hauptschleife mit Vorbereitung
...
c.create_text(MID_X, MID_Y + 30, text='Punkte: '+ str(score), fill='white', font=('Helvetica',30))
c.create_text(MID_X, MID_Y + 60, text='Bonus-Zeit: '+ str(bonus*TIME_LIMIT), fill='white', font=('Helvetica',30))
